...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_THREAD_BYTES, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_VM_SIZE, 0x800000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_ICOUNT_SHIFT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_ICOUNT_SLEEP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_GIC_V3_ITS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QEMU_CORTEX_A53_QEMU_CORTEX_A53, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_ARM64, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARCH_SUPPORTS_EVICTION_TRACKING, 1);
